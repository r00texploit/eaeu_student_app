...
import 'package:student/cubits/downloadFileCubit.dart';

import 'package:student/data/models/studyMaterial.dart';
import 'package:student/data/repositories/subjectRepository.dart';

import 'package:student/ui/widgets/downloadFileBottomsheetContainer.dart';
import 'package:student/ui/widgets/errorMessageOverlayContainer.dart';
...
class UiUtils {
  ...
  static String getTranslatedLabel(BuildContext context, String? labelKey) {
    // print(
    //     "translate $labelKey => ${AppLocalization(Locale('ar')).getTranslatedValues(labelKey)}");
  ...
  static String getPaymentsSubmissionStatusKey(int status) {
    if (status == 0) {
      return inReviewKey;
    }
    if (status == 1) {

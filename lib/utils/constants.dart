...
const String baseUrl = "https://alumni.eaeu.sd"; //https://eschool.wrteam.me
const String databaseUrl = "https://alumni.eaeu.sd/api/";

//error message display duration
const Duration errorMessageDisplayDuration = Duration(milliseconds: 5000);

import 'package:student/cubits/changePasswordCubit.dart';
import 'package:student/ui/widgets/bottomsheetTopTitleAndCloseButton.dart';
...
class _ChangePasswordBottomsheetState extends State<ChangePasswordBottomsheet> {
  ...
  Widget build(BuildContext context) {
    // print("object : ${UiUtils.getTranslatedLabel(context, changePasswordKey)}");
    return WillPopScope(
      onWillPop: () {
            ...
            children: [
              BottomsheetTopTitleAndCloseButton(
                ...
                titleKey: UiUtils.getTranslatedLabel(
                    context, changePasswordKey), // changePasswordKey,
              ),
              SizedBox(
